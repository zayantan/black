			...
			<div class="row">
				<section class='col-xs-12 col-sm-6 col-md-6'>
					...
					<section>
						...
						<div class="col-xs-6">
							<div class="">
								Cash: <input type="text" required class="form-control "
									name="cash" value="" />
							</div>
						</div>
						<div class="col-xs-6">
						...
						<div class="col-xs-6">
							<div class="">
								Goodwill: <input type="text" class="form-control"
									name="goodwill" value="" />
							</div>
						</div>
						<div class="col-xs-6">
						...
						<div class="col-xs-6">
							<div class="">
								Total Shareholder Equity: <input type="text"
									class="form-control" name="tse" value="" />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="">
						...
						<div class="col-xs-6">
							<div class="">
								Operating Free Cash Flow: <input type="text"
									class="form-control" name="ofcf" value="" />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="">
						...
						<div class="col-xs-6">
							<div class="">
								Change in Working Capital: <input type="text"
									class="form-control" name="wc" value="" />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="">
								Free Cash Flow to Equity: <input type="text"
									class="form-control" name="fcfe" value="" />
							</div>
						</div>
					</section>
				</section>
				<section class="col-xs-12 col-sm-6 col-md-6">
					...
					-->
						<div class="col-xs-6">
							<div class="">
								Depreciation/Amortization: <input type="text"
									class="form-control" name="depr" value="" />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="">
						...
						<div class="col-xs-6">
							<div class="">
								Deferred Unearned Revenue: <input type="text"
									class="form-control" name="defUnearnRev" value="" />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="">
						...
						<div class="col-xs-6">
							<div class="">
								Other Curret Liabilities: <input type="text"
									class="form-control" name="ocl" value="" />
							</div>
						</div>
						<div class="col-xs-6">
							<div class="">
								Total Current Liabilities: <input type="text"
									class="form-control" name="tcl" value="" />
							</div>
						</div>
						...
						<div class="col-xs-6">
							<div class="">
								Long Term Debt: <input type="text" class="form-control"
									name="ltd" value="" />
							</div>
						</div>
						<div class="col-xs-6">
